...
def evaluate_ofa_subnet(subnet, path,  net_config, data_loader, batch_size, device='cpu'):


    top1,latency = validate(subnet, path, net_config['r'][0], data_loader, batch_size, device='cpu')
    return top1,latency
...
def validate(net, path, image_size, data_loader, batch_size=100, device='cpu'):
