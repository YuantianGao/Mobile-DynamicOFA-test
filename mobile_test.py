...
def prepare_subnet(ofa_net, data_loader, bn_list, net_config, imagenet_data_path):
...
for i in range(7):  
	...
	data_loader,bn_list[0],net_config, imagenet_data_path))
    torch.save(optimal_networks[i], '/home/yuantian/DynamicOFA/model/model_' + str(i) + '.pth')
